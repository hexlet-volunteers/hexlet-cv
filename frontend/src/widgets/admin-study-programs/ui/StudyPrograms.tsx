          ...
          <Table.Thead>
            <Table.Tr>
              <Table.Th fz="md" py="xs" w="30%">
                {t('adminPage.studyPrograms.programName')}
              </Table.Th>
              <Table.Th fz="md" py="xs" w="30%">
                {t('adminPage.studyPrograms.programDuration')}
              </Table.Th>
              <Table.Th fz="md" py="xs" w="15%" ta="center">
                {t('adminPage.studyPrograms.programLessons')}
              </Table.Th>
              <Table.Th fz="md" py="xs" w="25%" ta="center">
                {t('adminPage.studyPrograms.programPublished')}
              </Table.Th>
            </Table.Tr>
          </Table.Thead>
          <Table.Tbody>
    ...
    <Container fluid py="md">
      ...
      <Group gap="xs" mb="md">
        ...
        <Button type="submit" variant="default">
          {t('adminPage.studyPrograms.button')}
        </Button>
      </Group>
      {renderTable()}
    </Container>

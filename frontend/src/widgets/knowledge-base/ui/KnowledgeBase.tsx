    ...
    if (articles.length === 0) {
      ...
      return (
        <Table withTableBorder verticalSpacing="md">
          <Table.Thead>
            <Table.Tr>
              <Table.Th fz="md" py="xs" w="35%">
                {t('adminPage.knowledgeBase.articleTitle')}
              </Table.Th>
              <Table.Th fz="md" py="xs" w="40%">
                {t('adminPage.knowledgeBase.articlecategory')}
              </Table.Th>
              <Table.Th fz="md" py="xs" w="25%" ta="center">
                {t('adminPage.knowledgeBase.articlePublished')}
              </Table.Th>
            </Table.Tr>
          </Table.Thead>
          <Table.Tbody>
  ...
  return (
    <Container fluid py="md">
      ...
      <Group gap="xs" mb="md">
        ...
        />
        <Button type="submit" component={Link} href="" variant="default">
          {t('adminPage.knowledgeBase.button')}
        </Button>
      </Group>
      {renderTable()}
    </Container>

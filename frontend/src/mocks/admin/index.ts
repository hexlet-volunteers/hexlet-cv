...
const mockMenu: AdminMenuDTO[] = [
  {
    ...
    items: [
      { label: 'Маркетинг',
        link: '/admin/marketing/articles',
        icon: 'IconSpeakerphone' },
      { label: 'Вебинары',
        link: '/admin/webinars',
        icon: 'IconVideo' },
      { label: 'База знаний',
        link: '/admin/knowledgebase',
        icon: 'IconBooks' },
      { label: 'Интервью',
...
export const adminHandlers = [
  ...
  // MARKETING
  http.get('*/admin/marketing/articles', async ({ request }) => {
    console.log('MSW: handler hit', request.url)
    ...
    return inertiaJson({
      ...
      props: {
        articles: mockMarketingArticles,
        adminMenu: mockMenu,
      },
      url: new URL(request.url).pathname,
      version: 'msw-dev',
  ...
  http.get('*/admin/marketing/stories', async ({ request }) => {
    console.log('MSW: handler hit', request.url)
  ...
  http.get('*/admin/marketing/reviews', async ({ request }) => {
    console.log('MSW: handler hit', request.url)
  ...
  http.get('*/admin/marketing/team', async ({ request }) => {
    console.log('MSW: handler hit', request.url)

    await delay()

    return inertiaJson({
      component: 'Admin/Marketing/Team/Index',
      props: {
        team: mockMarketingTeam,
        adminMenu: mockMenu,
      },
      url: new URL(request.url).pathname,
      version: 'msw-dev',
  ...
  http.get('*/admin/marketing/pricing', async ({ request }) => {
    console.log('MSW: handler hit', request.url)

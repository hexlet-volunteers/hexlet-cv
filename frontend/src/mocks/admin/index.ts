...
const marketingSections = {
  default: { data: mockMarketingArticles,
    component: 'Admin/Marketing/Articles/Index' },
  articles: { data: mockMarketingArticles,
    component: 'Admin/Marketing/Articles/Index' },
  stories: { data: mockMarketingStories,
    component: 'Admin/Marketing/Stories/Index' },
  reviews: { data: mockMarketingReviews,
    component: 'Admin/Marketing/Reviews/Index' },
  team: { data: mockMarketingTeam,
    component: 'Admin/Marketing/Team/Index' },
  pricing: { data: mockMarketingPricing,
